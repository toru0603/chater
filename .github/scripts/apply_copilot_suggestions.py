...
try:
    ...
    if author_login and 'github-actions' in author_login and 'Auto-applied Copilot' in commit_msg:
    ...
    try:
        ...
        if old_chunk:
            ...
            if idx != -1:
                ...
                commit_message = f'Auto-applied Copilot suggestion from comment {c.id} (by {author})'
                try:
                    repo.update_file(path, commit_message, new_text, contents.sha, branch=head_ref)
